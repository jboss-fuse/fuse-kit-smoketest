...
/**
 * A simple integration test for the camel-cxf-contract-first quickstart.  This code is mostly taken from the test found here:
 * https://github.com/jboss-fuse/fabric8/blob/1.2.0.redhat-6-2-x-patch/quickstarts/cxf/camel-cxf-contract-first/src/test/java/camelinaction/OrderTest.java
 */

public class CamelCXFContractFirstExampleTest {
    private static final Logger LOG = LoggerFactory.getLogger(CamelCXFContractFirstExampleTest.class);
    ...
    public void sendRequest() throws Exception {
        ...
        InputStream fis = CamelCXFContractFirstExampleTest.class.getResourceAsStream("/cxf-contract-first-request.xml");
